...
static const std::string VIDEO_FEED = "Lane window";
static const std::string ORIG_FEED = "Original window";
...
public:
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    LaneDetector myLaneDetector;

    cv::Mat laneMat;
	
    laneMat= myLaneDetector.getLane(cv_ptr->image);
